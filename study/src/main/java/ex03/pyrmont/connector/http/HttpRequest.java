...
public class HttpRequest implements HttpServletRequest {
    ...
    public void setContextPath(String path) {
        if (path == null) { this.contextPath = ""; } else { this.contextPath = path; }
    }
    ...
    public String getHeader(String name) {
        ...
        synchronized (headers) {
            ArrayList values = (ArrayList)headers.get(name);
            if (values != null) { return ((String)values.get(0)); } else { return null; }
        }
    }
    ...
    public Enumeration getHeaders(String name) {
        ...
        synchronized (headers) {
            ArrayList values = (ArrayList)headers.get(name);
            if (values != null) { return (new Enumerator(values)); } else { return (new Enumerator(empty)); }
        }
    }
    ...
    public int getIntHeader(String name) {
        String value = getHeader(name);
        if (value == null) { return (-1); } else { return (Integer.parseInt(value)); }
    }
    ...
    public String getParameter(String name) {
        ...
        if (values != null) { return (values[0]); } else { return (null); }
    }
    ...
    public String[] getParameterValues(String name) {
        parseParameters();
        String values[] = (String[])parameters.get(name);
        if (values != null) { return (values); } else { return null; }
    }
